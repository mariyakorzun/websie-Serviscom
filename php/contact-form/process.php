...
$options['from_address']        = 'YOUR_EMAIL';               // Address the email is sent from
$options['from_name']           = 'Contact Form';                              // Name to attach to the address
$options['to_addresses']        = array( 'korzun.mariya@yandex.ru' );               // To: addresse(s), add new array item for more
$options['bcc_addresses']       = array( 'korzun.mariya@yandex.ru' );               // BCC: addresse(s), add new array item for more
...
function getHtmlEmailContent()
{
	...
	if (!empty($fdata['phone'])) { $content .= 'Phone: ' . $fdata['phone'] . '<br>'; }
...
function getPlainEmailContent()
{
	...
	if (!empty($fdata['phone'])) { $content .= 'Phone: ' . $fdata['phone'] . PHP_EOL; }
	if (!empty($fdata['email'])) { $content .= 'Email: ' . $fdata['email']; }
